...
import torch
from data_utils import load_STS_data, load_snli_jsonl
...
# 模型保存路径
model_save_path = 'output/{}-sbert-{}-{}-{}'.format(train_dataset,
                                                    "roberta",
                                                    train_batch_size,
...
if train_dataset == "sts":
    ...
    snil_vocab = load_snli_jsonl("data/cnsd-snli/cnsd_snli_v1.0.train.jsonl")
